...
public:
	...
	typedef ::dds::sub::cond::QueryCondition<T>      		QueryCondition;
    typedef ::dds::sub::ReaderQuery<T>               		ReaderQuery;
...
public:
    ReadCondition create_readcondition(
    	...
    	// TODO: Add ReadCondition Instantiation
/*
